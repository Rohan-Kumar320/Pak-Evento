    ...
    <div className="relative w-full h-[500px]">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 text-center text-white">
        ...
        <p className="mt-4 text-lg max-w-2xl">
          We bring your ideas to life with seamless planning, flawless
          execution, and memorable experiences. From corporate gatherings to
          grand celebrations, we ensure every detail is perfect.
        </p>
